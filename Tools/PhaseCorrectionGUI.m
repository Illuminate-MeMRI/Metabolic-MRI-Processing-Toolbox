function varargout = PhaseCorrectionGUI(varargin)
% Description:   GUI to apply first and zero order phasing corrections.
% Creator: Quincy van Houtum       Version: 2.0          Date: 2024-12
% --------------------------------------------------------------------
% 
% [spec, zero_ph, first_ph] = csi_PhaseCorrectionGUI(...);
%
% INPUT:
%   1. Spectum as complex data list (N x 1).
%   2. Spectum (N x 1) + PPM x-axis (N x 1).
%   3. Spectum (N x 1) + Struct with fields:
